...
ActiveRecord::Schema.define(:version => 20181202142455) do

  create_table "W_SUUMO", :primary_key => "ID", :force => true do |t|
    t.integer  "営業所CD"
    t.integer  "ROWNO"
  ...
  create_table "building_nearest_stations", :force => true do |t|
  ...
  create_table "construction_approaches", :force => true do |t|
  ...
  create_table "construction_vendors", :force => true do |t|
    t.integer  "construction_id"
  ...
  create_table "mail_reactions", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
  ...
  create_table "market_buildings", :force => true do |t|
    t.string   "name"
    t.string   "address"
    t.float    "latitude",      :limit => 24
    t.float    "longitude",     :limit => 24
  ...
  add_index "monthly_statements", ["item_id", "yyyymm"], :name => "index_all_2"
  ...
  create_table "occur_sources", :force => true do |t|
    t.string   "code"
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "trust_attack_month_report_actions", :force => true do |t|
    ...
    t.string   "owner_name"
    t.string   "owner_address"
    t.float    "owner_latitude",               :limit => 24
    t.float    "owner_longitude",              :limit => 24
    t.text     "content"
    t.date     "approach_date"
    t.integer  "approach_kind_id"
  ...
  create_table "trust_attack_month_report_ranks", :force => true do |t|
    ...
    t.integer  "building_id"
    t.string   "building_name"
    t.float    "building_latitude",            :limit => 24
    t.float    "building_longitude",           :limit => 24
    t.boolean  "delete_flg",                                 :default => false
    t.datetime "created_at",                                                    :null => false
    t.datetime "updated_at",                                                    :null => false
  ...
  create_table "trust_attack_month_report_results", :force => true do |t|
    t.integer  "trust_attack_month_report_id"
  ...
  create_table "trust_attack_month_reports", :force => true do |t|
    ...
    t.float    "dm_to_tel_average",            :limit => 24
    t.integer  "visit_meet_plan"
    t.float    "visit_meet_par",               :limit => 24
  ...
  create_table "廃棄_backup_buildings", :force => true do |t|
    t.string   "code"
    t.string   "attack_code"
    t.string   "name"
    t.string   "address"
  ...
  create_table "廃棄_backup_owners", :force => true do |t|
    t.string   "code"
    t.string   "name"
    t.string   "address"
    t.float    "latitude",   :limit => 24
